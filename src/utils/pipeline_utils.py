...
class PathManager:
    ...
    def get_preprocessing_paths(self) -> Dict[str, str]:
        ...
        return {
            ...
            'train_features_categorical': f"{data_processed}X_train_categorical.parquet",
            'val_features_categorical': f"{data_processed}X_val_categorical.parquet",
            'test_features_categorical': f"{data_processed}X_test_categorical.parquet",
